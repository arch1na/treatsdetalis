...
class TREATS3 extends StatefulWidget {
  const TREATS3({super.key});

  @override
  State<TREATS3> createState() => _TREATS3State();
}

class _TREATS3State extends State<TREATS3> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Pet Patrol Chew Sticks Dog Treats for All Life Stage(Adult and Puppy) 500gm Pack (Mutton)',
                style: TextStyle(
            ...
            Row(
              children: [
                Padding(
                  padding: const EdgeInsets.only(left: 10),
                  child: Text('₹145',style: TextStyle(
                      color: Colors.black,
                      fontFamily: 'Inter',
                      fontSize: 14,
            ...
            Row(
              children: [
                ...
                Padding(
                    padding: EdgeInsets.only(left: 10, bottom: 45),
                    child: Column(
                      children: [
                        Text(
                          'Pet Patrol\nMutton\nNon Vegetarian\nAll Life Stages\nStick\nTraining,\nKeep Dog\nBusy, Teeth',
            ...
            Padding(
              ...
              child: Text('- Promotes dental health by reducing plaque and tartar buildup and strengthening jaw muscles.',
                style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Perfect for dogs of all sizes, from small breeds to large ones.', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Resealable Packaging: Keeps chew sticks fresh and allows for easy portioning, ensuring longer-lasting treats.',
                style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Made from carefully selected ingredients to ensure the best taste and quality for your furry friend.',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- These chew sticks are designed to provide extended chewing enjoyment for your pet.',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Use as a reward or training aid to reinforce positive behavior in your pet.',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
