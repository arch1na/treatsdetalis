...
class TREATS5 extends StatefulWidget {
  const TREATS5({super.key});

  @override
  State<TREATS5> createState() => _TREATS5State();
}

class _TREATS5State extends State<TREATS5> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Himalaya Healthy Dog Treats Adult, Dry,Chicken, 1 KG',
                style: TextStyle(
            ...
            Padding(
              ...
              child: Text(
                '- Healthytreats are treats fortified with herbal actives to provide nutrition and health benefits', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 10),
              child: Text('- Healthytreats supports skin health and fitness', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- A tasty chicken flavour, highly relished treat that helps to build a bond with your pet', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Fortified with Flaxseed, which supports skin health',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
            ...
            Padding(
              ...
              child: Text('- breed_recommendation: all breed sizes',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
