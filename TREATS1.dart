...
class TREATS1 extends StatefulWidget {
  const TREATS1({super.key});

  @override
  State<TREATS1> createState() => _TREATS1State();
}

class _TREATS1State extends State<TREATS1> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Drools Chicken andEgg Biscuit,Dog Treats -Jar, 900 g',
                style: TextStyle(
            ...
            Row(
              children: [
                ...
                //       fontSize: 15
                //   ),),
                // Text('  ₹489 ', style: TextStyle(
                //     color: Colors.black,
                //     fontWeight: FontWeight.bold,
                //     fontFamily: 'Inter',
                //     fontSize: 15
                // ),),
                // Text(' 11% Off', style: TextStyle(
            ...
            Padding(
              ...
              child: Text(
                '- Crunchy Texture helps Remove Plaque & Tarter Build-up', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Omega 3 & 6 Fatty Acids promotes Lustrous Coat', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text('- No added Colours & Flavours', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Vitamins & Minerals Fortified to help keep dogs at their best',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
