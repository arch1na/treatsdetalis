...
class TREATS2 extends StatefulWidget {
  const TREATS2({super.key});

  @override
  State<TREATS2> createState() => _TREATS2State();
}

class _TREATS2State extends State<TREATS2> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Purepet Chicken Flavour, Real Chicken Biscuit, Dog Treats For All Life Stages - Jar, 455g',
                style: TextStyle(
            ...
            Padding(
              ...
              child: Text(
                '- A worthy treat with carefully sourced ingredients, our oven baked biscuits are all natural, protein-packed treat, palatable enough for even the pickiest dogs', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- The crunchy texture of the biscuit helps to remove plaque & reduces tartar build up and bad breath', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- The combination of Omega 3 & 6 fatty acids promotes healthy skin and lustrous coat', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Fortified with Vitamins and Minerals help to keep your pet active and healthy',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Purepet dog biscuits are available in delightful flavors i.e. 100% Veg , Chicken, Mutton and Milk',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Ideal way to reward your pet each time fo their good behaviour',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
