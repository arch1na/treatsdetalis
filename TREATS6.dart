...
class TREATS6 extends StatefulWidget {
  const TREATS6({super.key});

  @override
  State<TREATS6> createState() => _TREATS6State();
}

class _TREATS6State extends State<TREATS6> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Goodies Energy Treats Bone Shaped For Adult Dogs, Lamb Flavour, 500 G',
                style: TextStyle(
            ...
            Padding(
              ...
              child: Text(
                '- This is a Non-vegetarian product.', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text('- With flavours calcium', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text('- Liver, lamb, chlorophyll', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
